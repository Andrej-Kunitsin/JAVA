...
public class ExListTest extends Assert
{
	...
	{
		int[] zz =
		{ 10, 20, 77, 11, 24, 99, 32 };
		int[] exp =
		{ 5, 10, 20, 77, 11, 24, 99, 32 };
		xx.setArray(zz);
		xx.addStart(5);
		int[] res = xx.getArray();
		assertEquals(exp, res);
	...
	{
		int[] zz =
		{ 20, 10, 77, 11, 24, 99, 32 };
		int[] exp =
		{ 10, 11, 20, 24, 32, 77, 99 };
		xx.setArray(zz);
		xx.sort();
		int[] res = xx.getArray();
		assertEquals(exp, res);
